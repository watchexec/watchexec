...
\[**-p**\|**\--postpone**\] \[**-q**\|**\--quiet**\]
\[**-Q**\|**\--quote**\] \[**-r**\|**\--restart**\]
\[**-s**\|**\--signal**\] \[**\--shell**\] \[**\--stdin-quit**\]
\[**\--stop-signal**\] \[**\--stop-timeout**\] \[**\--timeout**\]
\[**\--timings**\] \[**-v**\|**\--verbose**\]\...
\[**-w**\|**\--watch**\] \[**\--workdir**\]
...
them. Currently supported keys are: r to restart the command, p to
toggle pausing the watch, and q to quit. This requires a terminal (TTY)
and puts stdin into raw mode, so the child process will not receive
stdin input.
